...
The architecture calculates the numerical gradient of the Neural Net rather than calculate the exact gadient at any given point.  It is likely that the gradient of a neural net can be calculated for a dynamic architecture, but for now resides outside the scope of this project.
